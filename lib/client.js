window.__ModuleLoader__.load({ id: "hello-kitty-notifier", factory: (require) => { var module = { exports: {} }; var exports = module.exports;
"use strict";
...
function apply(ctx) {
  ...
  function show(kind) {
    ...
    leaveTimer = ctx.timeout(function () { state = { visible: true, leaving: true, kind: kind }; render(); }, 3400);
    hideTimer = ctx.timeout(function () { state = { visible: false, leaving: false, kind: kind }; render(); }, 3850);
    render();
  }
